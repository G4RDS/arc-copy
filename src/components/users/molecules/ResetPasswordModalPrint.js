...
const ResetPasswordModalPrint = ({ onComplete, user, password }) => {
...
ResetPasswordModalPrint.propTypes = {
  onComplete: PropTypes.func.isRequired,
  user: PropTypes.instanceOf(User),
  password: PropTypes.string,
}

export default ResetPasswordModalPrint
